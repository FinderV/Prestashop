...
public class User {
  ...
  private String emailAddressCreate = "5803@mail.ru";      // new create 1
  private String emailAddressCreateNew = "5804@mail.ru";             // new
  private String emailAddress = "5801@mail.ru";          // old next 1
  private String emailAddressWishlist = "5801@mail.ru";        //  old next  add wishlist 1
