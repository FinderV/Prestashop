...
public class User {
  ...
  private String emailAddressCreate = "5817@mail.ru";      // new create 1
  private String emailAddressCreateNew = "5818@mail.ru";             // new
  private String emailAddress = "5816@mail.ru";          // old next 1
  private String emailAddressWishlist = "5816@mail.ru";        //  old next  add wishlist 1
